...
**Subsequent package:** the current detailed branch-hold bootstrap is in `docs/approvals/2026-08-23-stage0-exact-release-hold-and-bootstrap-package.md`. Its exact starting point was refreshed after Donato's intended product-page GUI adjustment. Read `docs/evidence/2026-08-23-live-rebaseline-after-intended-product-gui-change.md` before execution. This document remains the design rationale and cost/permission record.
